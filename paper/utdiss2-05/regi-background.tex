...
%and illustrate the importance of analyzing recorded performances of music alongside the written melody.

%why metrics
%\cite{blumenfeldGenerativeMetricsOverview2016} \\
...
%
%music study cantonese
%\cite{yungCreativeProcessCantonese1983,yungCreativeProcessCantonese1983a,yungCreativeProcessCantonese1983b,wongMelodyToneRelation1999, wongHowCanLyrics2002}
%tone-tune other languages \cite{mcphersonTonetuneAssociationTommo2018}
